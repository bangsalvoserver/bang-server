...
namespace banggame {
    ...
    game_string effect_gift_card::on_prompt(card_ptr origin_card, player_ptr origin, card_ptr target_card, player_ptr target_player) {
        return prompts::bot_check_target_friend(origin, target_player);
    }

    void effect_gift_card::on_play(card_ptr origin_card, player_ptr origin, card_ptr target_card, player_ptr target_player) {

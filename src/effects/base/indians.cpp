...
namespace banggame {
    ...
    struct request_indians : request_auto_resolvable, interface_escapable, interface_picking, respondable_with_bang {
    ...
    prompt_string effect_indians::on_prompt(card_ptr origin_card, player_ptr origin, player_ptr target, effect_flags flags) {

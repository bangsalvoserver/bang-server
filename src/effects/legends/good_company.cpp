...
namespace banggame {
    ...
    void equip_good_company::on_enable(card_ptr origin_card, player_ptr origin) {
        ...
        origin->m_game->add_listener<event_type::on_destroy_card>(origin_card, [=](player_ptr e_origin, card_ptr e_origin_card, card_ptr target_card, bool is_destroyed, destroy_flags &flags) {

...
namespace banggame {
    ...
    game_string effect_missedlike::on_prompt(card *origin_card, player *origin) {
    ...
    game_string effect_heal_notfull::verify(card *origin_card, player *origin, player *target) {
        if (target->m_hp == target->m_max_hp) {

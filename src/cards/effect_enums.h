...
namespace banggame {
    ...
    DEFINE_ENUM_FWD_TYPES(effect_type,
        ...
        (queue_heal_notfull,    effect_queue_heal_notfull)
        (indians,               effect_indians)
        (draw,                  effect_draw)
        (queue_draw,            effect_queue_draw)
        ...
        (caravan,               effect_caravan)
        (a_little_nip,          effect_a_little_nip)
        (rust,                  effect_rust)
        ...
        (buffalo_bell,          effect_buffalo_bell)
    )
